...
class Texture extends EventDispatcher {
	...
	constructor( image = Texture.DEFAULT_IMAGE, mapping = Texture.DEFAULT_MAPPING, wrapS = ClampToEdgeWrapping, wrapT = ClampToEdgeWrapping, magFilter = LinearFilter, minFilter = LinearMipmapLinearFilter, format = RGBAFormat, type = UnsignedByteType, anisotropy = 1, encoding = LinearEncoding$1 ) {
			...
			if ( boxMesh === undefined ) {
				...
				boxMesh = new Mesh(
					...
					new ShaderMaterial( {
						...
						uniforms: cloneUniforms( ShaderLib$1.cube.uniforms ),
			...
			if ( planeMesh === undefined ) {
				...
				planeMesh = new Mesh(
					...
					new ShaderMaterial( {
						...
						uniforms: cloneUniforms( ShaderLib$1.background.uniforms ),
...
function _isLDR( texture ) {
	...
	return texture.encoding === LinearEncoding$1 || texture.encoding === sRGBEncoding || texture.encoding === GammaEncoding;
...
Object.defineProperties( WebGLRenderer.prototype, {
	...
	gammaOutput: {
		...
		set: function ( value ) {
			...
			console.warn( 'THREE.WebGLRenderer: .gammaOutput has been removed. Set WebGLRenderer.outputEncoding instead.' );
			this.outputEncoding = ( value === true ) ? sRGBEncoding : LinearEncoding$1;
...
class FloatNode$1 extends InputNode {
...
FloatNode$1.prototype.isFloatNode = true;
...
var EncodingFunctions = /*#__PURE__*/Object.freeze({
	__proto__: null,
...
const zeroValue = new FloatNode$1( 0 ).setConst( true );
...
class WebGPURenderer {
	...
	_projectObject( object, camera, groupOrder ) {
		...
		if ( visible ) {
			...
			} else if ( object.isLight ) ; else if ( object.isSprite ) {
